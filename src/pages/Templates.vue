          ...
          <div class="row h-100 align-items-center">
            <div class="col-12">
              <nav aria-label="breadcrumb" class="breadcumb--con text-center">
                <h2
                  class="w-text title wow fadeInUp"
                  data-wow-delay="0.2s"
                  style="
                    visibility: visible;
          ...
          <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="demo-item">
              <router-link to="preview"
                ><img
                  src="img/demos/demo-1.png"
                  alt="demo"
                  class="img-responsive"
              /></router-link>
              <div class="preview-btn-wrapper text-center">
                <router-link to="preview" class="preview-demo"
                  >See template <i class="fa fa-long-arrow-right"></i
                ></router-link>
                <router-link to="start" class="preview-demo v2"
