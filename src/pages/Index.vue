                        ...
                        <div class="col-12 col-lg-6 col-md-12">
                            <div class="welcome-content v2">
                                ...
                                <h1 class="wow fadeInUp" data-wow-delay="0.2s"
                                    style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">Online CV
                                    Builder With Creative Templates.</h1>
                                <p class="wow fadeInUp" data-wow-delay="0.3s"
                                    style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">Our
                                    Perfect
                    ...
                    <div class="row align-items-center">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="side-feature-list-item">
                                                ...
                                                <div class="foot-c-info">Proven CV Templates to increase Hiring Chance
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="side-feature-list-item">
                                                <img src="img/icons/check.png" class="check-mark-icon" alt="">
                                                <div class="foot-c-info">Free to use. Developed by hiring professionals.
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="welcome-meter wow fadeInUp mt-s" data-wow-delay="0.3s"
                                ...
                                <img src="img/cv.png" class="center-block" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="container section-padding-0-100">
                <div class="subscribe">
                    <div class="row align-items-center relative">
                        <img src="img/custom.png" alt="" class="custom">
                ...
                <div class="container">
                    ...
                    <div class="section-heading text-center">
                        ...
                        <h2 class="wow fadeInUp" data-wow-delay="0.3s"
                            style="visibility: hidden; animation-delay: 0.3s; animation-name: none;">Our Main Features</h2>
                        <p class="wow fadeInUp" data-wow-delay="0.4s"
                            style="visibility: hidden; animation-delay: 0.4s; animation-name: none;">Lorem ipsum dolor sit
                            amet,
